...
import com.example.adopy.FileSystemMemory;
...
public class HomeFragment extends Fragment implements ItemTouchHelperConnector {
    ...
    private void AddDialog(){
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getUid()).child(postKey).setValue(hashMapUsr).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(getContext(),getResources().getString(R.string.added),Toast.LENGTH_SHORT).show();
